...
#include "Validate_Upstream_RevisionfilterMarshal.h"
...
Validate_Upstream_RevisionfilterMarshal  marshal;        // Client and I/O stream state.
...
//
void  Validate_Upstream_RevisionfilterMarshal::receivedResult1(OutputTuple  *tuple)
{
  //..............................................................................
...
void Validate_Upstream_RevisionfilterMarshal::receivedResult2( OutputTuple *tuple )
{
  // call the same method above
  NOTICE << "  To FALSE port ...";
...
//
Validate_Upstream_RevisionfilterMarshal::Packet  read_one_tuple()
  throw ( bool )
{
  Validate_Upstream_RevisionfilterMarshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if (( DataFile.good()  &&
	( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Validate_Upstream_RevisionfilterMarshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Validate_Upstream_RevisionfilterMarshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
