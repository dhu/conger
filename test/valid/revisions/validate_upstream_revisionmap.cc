...
#include "Validate_Upstream_RevisionmapMarshal.h"
...
Validate_Upstream_RevisionmapMarshal  marshal;        // Client and I/O stream state.
...
//
void  Validate_Upstream_RevisionmapMarshal::receivedResult(OutputTuple  *tuple)
{
  //..............................................................................
...
//
Validate_Upstream_RevisionmapMarshal::Packet  read_one_tuple()
  throw ( bool )
{
  Validate_Upstream_RevisionmapMarshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if (( DataFile.good()  &&
	( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Validate_Upstream_RevisionmapMarshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Validate_Upstream_RevisionmapMarshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
