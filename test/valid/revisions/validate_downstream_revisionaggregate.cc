...
#include "Validate_Downstream_RevisionaggregateMarshal.h"
...
Validate_Downstream_RevisionaggregateMarshal  marshal;        // Client and I/O stream state.
...
//
void  Validate_Downstream_RevisionaggregateMarshal::receivedResult(OutputTuple  *tuple)
{
  //..............................................................................
...
//
Validate_Downstream_RevisionaggregateMarshal::Packet  read_one_tuple()
  throw ( bool )
{
  Validate_Downstream_RevisionaggregateMarshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if (( DataFile.good()  &&
	( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Validate_Downstream_RevisionaggregateMarshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Validate_Downstream_RevisionaggregateMarshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
