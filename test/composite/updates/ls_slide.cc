...
//
void Ls_SlideMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Ls_SlideMarshal::setStringField(string(sensor_id), 
...
//
void Ls_SlideMarshal::receivedOutput1(AggTuple *tuple)
{
    char sensor_id[5];
...
{
    Ls_SlideMarshal marshal; // Client and I/O stream state.
