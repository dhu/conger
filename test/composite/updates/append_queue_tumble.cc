...
#include "Append_Queue_TumbleMarshal.h"
...
//
void Append_Queue_TumbleMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Append_Queue_TumbleMarshal::setStringField(string(sensor_id), 
...
//
void Append_Queue_TumbleMarshal::receivedOutput1(AggTuple *tuple)
{
    char sensor_id[5];
...
{
    Append_Queue_TumbleMarshal marshal; // Client and I/O stream state.
