...
#include "Update_Queue3Marshal.h"
...
//
void Update_Queue3Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue3Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue3Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue3Marshal marshal; // Client and I/O stream state.
