...
#include "Update_Queue0Marshal.h"
...
//
void Update_Queue0Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue0Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue0Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue0Marshal marshal; // Client and I/O stream state.
