...
#include "Update_Queue7Marshal.h"
...
//
void Update_Queue7Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue7Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue7Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue7Marshal marshal; // Client and I/O stream state.
