...
#include "Update_Queue1Marshal.h"
...
//
void Update_Queue1Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue1Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue1Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue1Marshal marshal; // Client and I/O stream state.
