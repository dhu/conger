...
//
void Ls_TumbleMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Ls_TumbleMarshal::setStringField(string(sensor_id), 
...
//
void Ls_TumbleMarshal::receivedOutput1(AggTuple *tuple)
{
    char sensor_id[5];
...
{
    Ls_TumbleMarshal marshal; // Client and I/O stream state.
