...
#include "Update_Queue6Marshal.h"
...
//
void Update_Queue6Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue6Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue6Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue6Marshal marshal; // Client and I/O stream state.
