...
#include "Update_Queue_Tumble4Marshal.h"
...
//
void Update_Queue_Tumble4Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue_Tumble4Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue_Tumble4Marshal::receivedOutput1(AggTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue_Tumble4Marshal marshal; // Client and I/O stream state.
