...
//
void Append_QueueMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Append_QueueMarshal::setStringField(string(sensor_id), 
...
//
void Append_QueueMarshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Append_QueueMarshal marshal; // Client and I/O stream state.
