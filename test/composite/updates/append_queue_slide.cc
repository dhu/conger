...
#include "Append_Queue_SlideMarshal.h"
...
//
void Append_Queue_SlideMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Append_Queue_SlideMarshal::setStringField(string(sensor_id), 
...
//
void Append_Queue_SlideMarshal::receivedOutput1(AggTuple *tuple)
{
    char sensor_id[5];
...
{
    Append_Queue_SlideMarshal marshal; // Client and I/O stream state.
