...
#include "Update_Queue2Marshal.h"
...
//
void Update_Queue2Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue2Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue2Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue2Marshal marshal; // Client and I/O stream state.
