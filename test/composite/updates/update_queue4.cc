...
#include "Update_Queue4Marshal.h"
...
//
void Update_Queue4Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue4Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue4Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue4Marshal marshal; // Client and I/O stream state.
