...
void LsMarshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        LsMarshal::setStringField(string(sensor_id), 
...
//
void LsMarshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
int main(int argc, const char *argv[])
{
    ...
    LsMarshal marshal; // Client and I/O stream state.
