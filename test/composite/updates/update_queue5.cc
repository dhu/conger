...
#include "Update_Queue5Marshal.h"
...
//
void Update_Queue5Marshal::sentInput1()
{
    ...
    for (unsigned int i = 0; i < batch_size; ++i)
    {
        ...
        Update_Queue5Marshal::setStringField(string(sensor_id), 
...
//
void Update_Queue5Marshal::receivedOutput1(SensorTuple *tuple)
{
    char sensor_id[5];
...
{
    Update_Queue5Marshal marshal; // Client and I/O stream state.
