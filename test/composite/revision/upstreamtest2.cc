...
#include "args.h"
#include "Upstreamtest2Marshal.h"
...
//
void  Upstreamtest2Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
  //..............................................................................
...
//
Upstreamtest2Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest2Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest2Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest2Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest2Marshal   marshal;        // Client and I/O stream state.
  //
