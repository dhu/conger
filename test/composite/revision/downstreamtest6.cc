...
#include "args.h"
#include "Downstreamtest6Marshal.h"
...
//
void  Downstreamtest6Marshal::receivedResult1(  // PacketTuple  *tuple
					      OutputTuple  *tuple
					      )
{
  //..............................................................................
...
void Downstreamtest6Marshal::receivedResult2( OutputTuple *tuple )
{
...
//
Downstreamtest6Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest6Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest6Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest6Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest6Marshal   marshal;        // Client and I/O stream state.
  //
