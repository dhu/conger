...
#include "args.h"
#include "Downstreamtest1Marshal.h"
...
//
void  Downstreamtest1Marshal::receivedResult(  // PacketTuple  *tuple
					     OutputTuple  *tuple
					     )
{
  //..............................................................................
...
//
Downstreamtest1Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest1Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest1Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest1Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest1Marshal   marshal;        // Client and I/O stream state.
  //
