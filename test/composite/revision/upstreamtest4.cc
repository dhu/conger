...
#include "args.h"
#include "Upstreamtest4Marshal.h"
...
//
void  Upstreamtest4Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
  //..............................................................................
...
//
Upstreamtest4Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest4Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest4Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest4Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest4Marshal   marshal;        // Client and I/O stream state.
  //
