...
#include "args.h"
#include "Downstreamtest7Marshal.h"
...
//
void  Downstreamtest7Marshal::receivedResult1(  // PacketTuple  *tuple
					      OutputTuple  *tuple
					      )
{
  //..............................................................................
...
void Downstreamtest7Marshal::receivedResult2( OutputTuple *tuple )
{
...
//
Downstreamtest7Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest7Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest7Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest7Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest7Marshal   marshal;        // Client and I/O stream state.
  //
