...
#include "args.h"
#include "Downstreamtest5Marshal.h"
...
//
void  Downstreamtest5Marshal::receivedResult(  // PacketTuple  *tuple
					     OutputTuple  *tuple
					     )
{
  //..............................................................................
...
//
Downstreamtest5Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest5Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest5Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest5Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest5Marshal   marshal;        // Client and I/O stream state.
  //
