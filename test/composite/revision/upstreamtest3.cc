...
#include "args.h"
#include "Upstreamtest3Marshal.h"
...
//
void  Upstreamtest3Marshal::receivedResult1(  // PacketTuple  *tuple
					    OutputTuple  *tuple
					    )
{
  //..............................................................................
...
void Upstreamtest3Marshal::receivedResult2( OutputTuple *tuple )
{
...
//
Upstreamtest3Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest3Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest3Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest3Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest3Marshal   marshal;        // Client and I/O stream state.
  //
