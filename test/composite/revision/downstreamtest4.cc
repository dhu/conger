...
#include "args.h"
#include "Downstreamtest4Marshal.h"
...
//
void  Downstreamtest4Marshal::receivedResult(  // PacketTuple  *tuple
					     OutputTuple  *tuple
					     )
{
  //..............................................................................
...
//
Downstreamtest4Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest4Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest4Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest4Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest4Marshal   marshal;        // Client and I/O stream state.
  //
