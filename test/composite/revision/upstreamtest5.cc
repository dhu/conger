...
#include "args.h"
#include "Upstreamtest5Marshal.h"
...
//
void  Upstreamtest5Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
  //..............................................................................
...
//
Upstreamtest5Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest5Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest5Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest5Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest5Marshal   marshal;        // Client and I/O stream state.
  //
