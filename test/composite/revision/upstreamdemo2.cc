...
#include "args.h"
#include "Upstreamdemo2Marshal.h"
...
//
void  Upstreamdemo2Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
    //..............................................................................
...
/*
void Demo2Marshal::receivedResult2( PacketTuple *tuple )
{
    receivedResult( tuple );
    NOTICE << "    to output Result2";
}

void Demo2Marshal::receivedResult3( PacketTuple *tuple )
{
    receivedResult( tuple );
...
//
Upstreamdemo2Marshal::Packet  read_one_tuple()
    throw( bool )
{
    Upstreamdemo2Marshal::Packet  p;
    char      buf[ TEMP_BUF ];
    //..............................................................................
           ...
           ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
        ...
        Upstreamdemo2Marshal::setStringField( quote, p._data.quote, 4 );
//      Demo2Marshal::setStringField( revised_val, p._data.revised_field, 4 );
        ...
        NOTICE << "Input (tid=" << p.tuple_id
              << ",type=" << (p.tuple_type == TupleType::INSERTION ? "INSERTION"   :
			                p.tuple_type == TupleType::DELETION ? "DELETION"    :
							 ...
							 p.tuple_type == TupleType::DELIMITER ? "DELIMITER"   : "UNKNOWN")
			  << ",rev_id=" << p.rev_id
              << ",revised=" << p.rev_field
              << ",time=" << p._data.time
...
//
void  Upstreamdemo2Marshal::sentPacket()
{
    int32     timestamp;
    Time      current_time;
    //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
    ...
    string    file_name;
    int32     status;
    Upstreamdemo2Marshal   marshal;        // Client and I/O stream state.
    //
