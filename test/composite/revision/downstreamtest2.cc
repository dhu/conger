...
#include "args.h"
#include "Downstreamtest2Marshal.h"
...
//
void  Downstreamtest2Marshal::receivedResult(  // PacketTuple  *tuple
					     OutputTuple  *tuple
					     )
{
  //..............................................................................
...
//
Downstreamtest2Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest2Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest2Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest2Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest2Marshal   marshal;        // Client and I/O stream state.
  //
