...
#include "args.h"
#include "Downstreamtest3Marshal.h"
...
//
void  Downstreamtest3Marshal::receivedResult1(  // PacketTuple  *tuple
					      OutputTuple  *tuple
					      )
{
  //..............................................................................
...
void Downstreamtest3Marshal::receivedResult2( OutputTuple *tuple )
{
...
//
Downstreamtest3Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Downstreamtest3Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Downstreamtest3Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamtest3Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Downstreamtest3Marshal   marshal;        // Client and I/O stream state.
  //
