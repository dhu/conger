...
#include "args.h"
#include "Upstreamtest1Marshal.h"
...
//
void  Upstreamtest1Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
  //..............................................................................
...
//
Upstreamtest1Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest1Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest1Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest1Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest1Marshal   marshal;        // Client and I/O stream state.
  //
