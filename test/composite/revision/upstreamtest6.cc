...
#include "args.h"
#include "Upstreamtest6Marshal.h"
...
//
void  Upstreamtest6Marshal::receivedResult1(  // PacketTuple  *tuple
					    OutputTuple  *tuple
					    )
{
  //..............................................................................
...
void Upstreamtest6Marshal::receivedResult2( OutputTuple *tuple )
{
...
//
Upstreamtest6Marshal::Packet  read_one_tuple()
  throw( bool )
{
  Upstreamtest6Marshal::Packet  p;
  char      buf[ TEMP_BUF ];
  //..............................................................................
  ...
  if ((  DataFile.good()  &&
	 ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
      ...
      Upstreamtest6Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Upstreamtest6Marshal::sentPacket()
{
  int32     timestamp;
  Time      current_time;
  //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
  ...
  string    file_name;
  int32     status;
  Upstreamtest6Marshal   marshal;        // Client and I/O stream state.
  //
