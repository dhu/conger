...
//
void Nh_Ls_EqualMarshal::sentInput1()
{
    uint32 sleep_time;
...
void Nh_Ls_EqualMarshal::sentInput2()
{
    uint32 sleep_time;
...
//
void Nh_Ls_EqualMarshal::receivedOutput1(OutputSchema *tuple)
{
...
// Print the content of received tuples.
//
void Nh_Ls_EqualMarshal::receivedOutput2(OutputSchema *tuple)
{
