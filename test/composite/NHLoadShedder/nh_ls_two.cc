...
//
void Nh_Ls_TwoMarshal::sentInput1()
{
    uint32 sleep_time;
...
void Nh_Ls_TwoMarshal::sentInput2()
{
    uint32 sleep_time;
...
//
void Nh_Ls_TwoMarshal::receivedOutput1(OutputSchema *tuple)
{
...
// Print the content of received tuples.
//
void Nh_Ls_TwoMarshal::receivedOutput2(OutputSchema *tuple)
{
...
int main(int argc, const char *argv[])
{
    ...
    else
    {
        ...
        DEBUG << "base sleep time2 = " << base_sleep_time2;
