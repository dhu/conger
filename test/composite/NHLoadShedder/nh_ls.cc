...
//
void Nh_LsMarshal::receivedOutput1(OutputSchema *tuple)
{
...
// Print the content of received tuples.
//
void Nh_LsMarshal::receivedOutput2(OutputSchema *tuple)
{
