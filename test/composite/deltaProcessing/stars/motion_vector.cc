...
MotionvectorMarshal   marshal;        // Client and I/O stream state.
...
void load_out_image(string filename, uint8 *channel)
{
    ...
    if(fin.is_open())
      {
	    ...
	    int header_size = size - OUTPUT_FRAME_WIDTH*SCROLL_HEIGHT;
		int rem_size = OUTPUT_FRAME_WIDTH*SCROLL_HEIGHT;
		DEBUG << "Total size: " << size << " header is: " << header_size << " remainder is " << rem_size;
        fin.seekg(0, ios::beg);
...
void compare_images(string filename_1, string filename_2)
{
  int num_vals = OUTPUT_FRAME_WIDTH*SCROLL_HEIGHT;
  uint8 *buffer_1 = new uint8[num_vals];
  uint8 *buffer_2 = new uint8[num_vals];

  load_out_image(filename_1, buffer_1);
  load_out_image(filename_2, buffer_2);
  for(int x = 0; x < num_vals; ++x)
    if(buffer_1[x] != buffer_2[x])
      DEBUG << "Discrepancy at value: " << x << " uncompressed has " << (int) buffer_1[x] << " mv has: " << (int) buffer_2[x];
...
//
void  MotionvectorMarshal::receivedScroller(scrolling_frame  *tuple)
{
//..............................................................................
...
//
void  MotionvectorMarshal::sentI_Frame()
{
...
// Return here after sending a packet and a delay.
//
void  MotionvectorMarshal::sentR_Frame()
{
...
void  MotionvectorMarshal::sentG_Frame()
{
...
void  MotionvectorMarshal::sentO_Frame_1()
{
}

void  MotionvectorMarshal::sentO_Frame_2()
{
} 
////////////////////////////////////////////////////////////////////////////////
//
