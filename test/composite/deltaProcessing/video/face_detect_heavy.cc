...
FacedetectMarshal   marshal;        // Client and I/O stream state.
...
bool loadImageCCD(string fileName)
{
  ...
  ifstream fin(fileName.c_str(), ios::in | ios::binary);
    ...
    //NOTICE << "First values: " << (int) buffer[0][0] << ", " <<  (int)  buffer[0][1] << ", " <<  (int) buffer[0][2];
...
//
void  FacedetectMarshal::receivedCcddetected(ccd_schema  *tuple)
{
	clock_t timestamp;
...
//..............................................................................
  //NOTICE << "Out values: " <<  (int)*(tuple->frame) << ", " <<  (int) *(tuple->frame + 1) << ", " <<  (int)  *(tuple->frame + 2);
	...
	timestamp = clock();
    DEBUG << "Receive time: " << timestamp;
	recv_times.push_back(timestamp);
      tempImage = SDL_CreateRGBSurface(SDL_SWSURFACE, FRAME_WIDTH, FRAME_HEIGHT, 32, rmask, gmask, bmask, amask);
    if(tempImage == NULL)
      {
	cerr << "CreateRGBSurface failed: " << SDL_GetError() << endl;
...
//
void  FacedetectMarshal::sentCcdstream()
{
    int32        timestamp;
    Time         current_time;
    ostringstream os;
...
//..............................................................................
    ...
    {
    	timestamp = clock();
    	DEBUG << "Send time: " << timestamp;   
    	sent_times.push_back(timestamp);
...
/*void FacedetectMarshal::sentCcdchunked()
{
} */
////////////////////////////////////////////////////////////////////////////////
//
