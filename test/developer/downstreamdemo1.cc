...
#include "args.h"
#include "Downstreamdemo1Marshal.h"
...
//
void  Downstreamdemo1Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
    //..............................................................................
...
//
Downstreamdemo1Marshal::Packet  read_one_tuple()
    throw( bool )
{
    Downstreamdemo1Marshal::Packet  p;
    char      buf[ TEMP_BUF ];
    //..............................................................................
           ...
           ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
        ...
        Downstreamdemo1Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamdemo1Marshal::sentPacket()
{
    int32     timestamp;
    Time      current_time;
    //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
    ...
    string    file_name;
    int32     status;
    Downstreamdemo1Marshal   marshal;        // Client and I/O stream state.
    //
