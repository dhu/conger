...
#include "args.h"
#include "Downstreamdemo2Marshal.h"
...
//
void  Downstreamdemo2Marshal::receivedResult(  // PacketTuple  *tuple
                                           OutputTuple  *tuple
                                           )
{
    //..............................................................................
...
//
Downstreamdemo2Marshal::Packet  read_one_tuple()
    throw( bool )
{
    Downstreamdemo2Marshal::Packet  p;
    char      buf[ TEMP_BUF ];
    //..............................................................................
           ...
           ( !DataFile.getline( buf, TEMP_BUF ).eof() )))
    {
        ...
        Downstreamdemo2Marshal::setStringField( quote, p._data.quote, 4 );
...
//
void  Downstreamdemo2Marshal::sentPacket()
{
    int32     timestamp;
    Time      current_time;
    //..............................................................................
...
int  main( int  argc, const char  *argv[] )
{
    ...
    string    file_name;
    int32     status;
    Downstreamdemo2Marshal   marshal;        // Client and I/O stream state.
    //
