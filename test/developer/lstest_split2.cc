...
#include "Lstest_Split2Marshal.h"
...
//
void Lstest_Split2Marshal::sentInput1()
{
...
// Send an random input.
//
void Lstest_Split2Marshal::sentInput2()
{
    static long old_time = Time::now().to_usecs();
    static int count = 0;
...
//
void Lstest_Split2Marshal::receivedOutput1(IntTuple *tuple)
{
    static int count = 0;
    static long old_time = Time::now().to_usecs();
...
// Print the content of received tuples.
//
void Lstest_Split2Marshal::receivedOutput2(IntTuple *tuple)
{
    static int count;
    static long old_time = Time::now().to_usecs();
...
// Print the content of received tuples.
//
void Lstest_Split2Marshal::receivedOutput3(IntTuple *tuple)
{
    static int count;
    static long old_time = Time::now().to_usecs();
...
// Print the content of received tuples.
//
void Lstest_Split2Marshal::receivedOutput4(IntTuple *tuple)
{
    static int count;
    static long old_time = Time::now().to_usecs();
...
{
    Lstest_Split2Marshal marshal; // Client and I/O stream state.
