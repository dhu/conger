...
//
void  MaptestMarshal::receivedResult( OutputTuple  *tuple )
{
    //..............................................................................


    // Start time
    NOTICE << "Tuple (" << tuple->addten << "," << tuple->multiplyten << "," << tuple->protocol << ")" ;
...
//
void  MaptestMarshal::sentPacket()
{
    int32        random_index;
    int32        timestamp;
    Time         current_time;
    ...
    {   random_index = rand() % PROTOCOL_SIZE;
        ...
        tuple._data.type        = 1;
        tuple._data.key         = timestamp;
        tuple._data.revision_id = -1;
...
int  main( int  argc, const char  *argv[] )
{
    ...
    int32           status;
    MaptestMarshal   marshal;        // Client and I/O stream state.
//
