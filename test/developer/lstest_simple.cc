...
#include "Lstest_SimpleMarshal.h"
...
// Send a random input.
//
void Lstest_SimpleMarshal::sentInput1()
{
    /*
...
//
void Lstest_SimpleMarshal::receivedOutput1(IntTuple *tuple)
{
    static int count = 0;
    static long old_time = Time::now().to_usecs();
...
{
    Lstest_SimpleMarshal marshal; // Client and I/O stream state.
