...
//
void  Join_TestMarshal::receivedJoinoutput( JoinTuple  *tuple )
{
...
//
void  Join_TestMarshal::sentInput1()
{
    int32        timestamp;
    Time         current_time;
...
// Return here after sending a packet and a delay.
//
void  Join_TestMarshal::sentInput2()
{
    int32        timestamp;
    Time         current_time;
...
int  main( int  argc, const char  *argv[] )
{
    ...
    int32              status;
    Join_TestMarshal   marshal;        // Client and I/O stream state.
