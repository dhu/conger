...
struct dynent                           // players & monsters
{
    ...
    // Added by Rick
    CBot *pBot; // Only used if this is a bot, points to the bot class if we are the host, for other clients its NULL
...
#define MAXCLIENTS 1024                  // in a multiplayer game, can be arbitrarily changed
