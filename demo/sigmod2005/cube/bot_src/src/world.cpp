...
void delent()
{
    ...
    NMSTL::ptr<cube_edit_ent_tuple> ct = NMSTL::ptr<cube_edit_ent_tuple>(new cube_edit_ent_tuple());
    ct->entity_length = e;
    ct->entity_type = NOTUSED;
    ct->entity_x = 0;
    ct->entity_y = 0;
    ct->entity_z = 0;
    ct->entity_attribute1 = 0;
    ct->entity_attribute2 = 0;
    ct->entity_attribute3 = 0;
    ct->message = 0;

    client_pending_message.push_back(std::make_pair((int)SV_EDITENT, ct.dynamic_cast_to<borealis_tuple>()));
...
entity *newentity(int x, int y, int z, char *what, int v1, int v2, int v3, int v4)
{
    ...
    NMSTL::ptr<cube_edit_ent_tuple> t = NMSTL::ptr<cube_edit_ent_tuple>(new cube_edit_ent_tuple());
    t->entity_length = ents.length();
    t->entity_type = type;
    t->entity_x = e.x;
    t->entity_y = e.y;
    t->entity_z = e.z;
    t->entity_attribute1 = e.attr1;
    t->entity_attribute2 = e.attr2;
    t->entity_attribute3 = e.attr3;
    t->message = e.attr4;

    client_pending_message.push_back(std::make_pair((int)SV_EDITENT, t.dynamic_cast_to<borealis_tuple>()));
