...
public class MonitorFrameAboutBox extends JDialog  implements ActionListener{
  ...
  public MonitorFrameAboutBox(Frame parent) {
    super(parent);
  ...
  private void jbInit() throws Exception  {
    image1 = new ImageIcon(MonitorFrameAboutBox.class.getResource("about.png"));
    ...
    label1.setText("Borealis Monitor");
