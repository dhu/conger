#ifndef DELTA_SAMPLE_QBOX_H
#define DELTA_SAMPLE_QBOX_H
...
class DeltaDetectSampleQBox : public QBox
{
  friend class DeltaDetectSampleBoxState;
...
protected:
    ...
    ~DeltaDetectSampleQBox();
};



class DeltaDetectSampleBoxState : public AbstractBoxState
{
 public:
  DeltaDetectSampleBoxState() {}
  ~DeltaDetectSampleBoxState() {}
};
