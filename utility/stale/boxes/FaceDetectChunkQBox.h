#ifndef CHUNK_FACE_DETECT_QBOX_H
#define CHUNK_FACE_DETECT_QBOX_H
...
class FaceDetectChunkQBox : public QBox
{
  friend class FaceDetectChunkBoxState;
...
class FaceDetectChunkBoxState : public AbstractBoxState
{
 public:
  FaceDetectChunkBoxState() {}
  ~FaceDetectChunkBoxState() {}
};
